    ...
    app.post('/app/authentication/', function (req, res) {
        ...
        DadosUser = request({
            ...
            if (response.statusCode != 201) {
                ...
                req.session.IdUser = body.usuario.id;
                req.session.NomeUser = body.usuario.nome;
                req.session.NivelUser = body.usuario.niveis;
                req.session.EmailUser = body.usuario.email;
                res.redirect('/');
                return true;
            }
